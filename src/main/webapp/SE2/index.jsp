...
<%@ include file="/layout/header.jsp" %>
    ...
    <div class="container-fluid">
      <div class="row">
		...
		<form action="${pageContext.request.contextPath}/insertBoard" method="post" id="frm" style="margin-left:400px;">
			<input type="hidden" name="mem_id" value="${userVO.mem_id}">
			<br><br>
			제목 : 
			<input type="text" name="boardTitle" style="width:730px;"><br>
			<textarea name="smarteditor" id="smarteditor" rows="10" cols="100" style="width:766px; height:412px;"></textarea> 
		</form>
		<input type="button" id="savebutton" value="글 등록" style="margin-left:400px;"/>
